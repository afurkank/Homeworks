...
ppm_files = [f for f in os.listdir("/home/furkan/METU/Ceng477/HW1/code_template/without_shadows/") if f.endswith(".ppm")]
# Sort
ppm_files.sort()
...
for ppm_file in ppm_files:
    expected_file = "/home/furkan/METU/Ceng477/HW1/outputs_nobfc/" + ppm_file
    num_diff_pixels = 0
    total_pixels = 0
